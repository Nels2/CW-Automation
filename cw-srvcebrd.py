...
pickle.dump( str(total_reb), open( "RT.p", "wb"))
print_blue("|    EdgeUpdate Type:                          "+str(total_egu)+"     | ")
pickle.dump( str(total_egu), open( "EU.p", "wb"))
print_blue("|    Disk Cleanup Type:                        "+str(total_dc)+"     | ")
pickle.dump( str(total_dc), open( "DC.p", "wb"))
print_blue("|    NIC Type:                                 "+str(total_nic)+"     |")
pickle.dump( str(total_nic), open( "NT.p", "wb"))
print_yellow('#### ---------------------------------------------------------- ####')
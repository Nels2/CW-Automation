...
print_blue("[BrinxBot]: starting out.. login in to Automate is first task... commencing...")
...
print_blue("[BrinxBot]: Logging into Office... ")
driver.execute_script("window.open('about:blank', 'tab2');")
driver.switch_to.window("tab2")
print_blue("[BrinxBot]: Switched to second tab. Focus is here currently.")
...
print_blue("[BrinxBot]: No. I dont want to stay signed in... continuing")
# time to open the email and grab the code...
print_blue("[BrinxBot]: I'm in! Going to look for the email and save the code..")
time.sleep(7)
...
print_blue("[BrinxBot]: I have split the original message to just the code!: " + da_code)
# now to switch back to tab 1.. [Automate Login Screen]
print_blue("[BrinxBot]: ...switching back to Automate Login Screen and inserting code to login")
time.sleep(3)
...
print_yellow("#### Login was successful ####")
...
print_green("[AC][BrinxBot]: I'm in! Looking for computer: " + computer + "!")
...
print_blue("[BrinxBot]: Computer has been found clicking on it to continue the task...")
search_for_comp.send_keys(computer + Keys.RETURN)
element = driver.find_element_by_css_selector("#root > div > div > div > div.browse-container > div.company-container > div.company-content > div:nth-child(3) > div.CwDataGrid-rowsContainer > div > div > span:nth-child(1) > div").click()
...
print_green("[BrinxBot]: ..script has been found.")
...
print_blue("[BrinxBot]: Inside " + computer + " menu now, launching script...")

# -- wait for dialog box to appear.. -- #
print_blue("[BrinxBot]: waiting for dialog box..")
...
print_blue("[BrinxBot]: checking the 'do late' option so the script runs at a different time.")
...
print_blue("[BrinxBot]: Changing the date to tomorrow.")
...
print_green("[BrinxBot]: Date has been changed.")
# --------------------------------------
# change time script is ran to 12:00:00 AM
print_blue("[BrinxBot]: Changing the time to 12a")
...
print_green("[BrinxBot]: Time has been changed")
# -------------------------------
# click SCHEDULE
print_blue("[BrinxBot]: Wrapping this up & selecting OK...")
...
print_green("[BrinxBot]: I have completed the task assigned... shutting off after letting server know...")
...
def Server_ReReConnect():
    try:
        ...
        Connection.send_keys("Computer ticket has been completed successfully in CWA!" + Keys.RETURN)
    except RuntimeError:
        print_red("Server Connection Failed. Continuing with shutdown")
    driverTwo.quit()
Server_ReReConnect()
print_red("$- Connection has been lost to BrinxBot.")
print("---------------------------------------------------------------")